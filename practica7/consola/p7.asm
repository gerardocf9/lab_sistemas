...
; Lectura de archivo
; Solicitud de M
; Busqueda del BlockAlign
; Se copian las cabeceras para el nuevo archivo
; Se recorre el archivo anterior en saltos de M almacenando en el nuevo archivo
...
iteraciones     DD ?    ; Cant_iteraciones para alcanzar el tamano necesario
...
Start:
    ...
    xor eax, eax
	mov eax,[ebx+40] ;obtencion del tamano del archivo
